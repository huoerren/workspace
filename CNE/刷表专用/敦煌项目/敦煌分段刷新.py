...
days = "BETWEEN '2021-08-26 16:00:00' and " + "'" + nows + "' "
print(days)
...
lg_bag lgb,
lg_bag_order_relation lbor 
where tme.event_code in("IRCM","PVCS","IRCN","RFIC",'BGRK')  
and lgo.gmt_create {}
AND lgo.platform="DHLINK" 
...
print(dll)
name_l = [['出库监控', dck], ['装车监控', dzc], ['起飞监控', dqf], ['落地监控', dl], ['清关全', dq], ['主单全', execude_sql(s12)],['交付节点', djf], ['断更监控', ddg], ['交付监控', dj], ['落地节点', dll], ['未配载监控', dp]]



def file_xlsx(name, df):
    bf = r'F:\PBI临时文件\敦煌分段监控\{}.xlsx'.format(name)
