...
# days = """ BETWEEN '2022-01-23 16:00:00' and '2022-01-30 16:00:00'   """
...
and lgo.is_deleted='n'
and lgo.mawb_id=tme.mawb_id
and tme.event_code in ("IRCM","PVCS","IRCN","RFIC","BGRK","RHCC","RHIR","RFES","RELE")
""".format(tp_order)
...
data_Cal = total[total['装车用时'], total['起飞用时'], total['飞行用时'] ]
print(data_Cal.head())
