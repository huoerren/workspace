...
dateStr = """ BETWEEN '2021-08-31 16:00:00' and '2021-09-30 16:00:00'   """
channelCode = """ 'CNE全球特货' """
desList = ['MX']
...
def getAcount(i):
    ...
    zhuangche_qifei = pd.merge(d2, d5[['内单号', '起飞时间']], left_on='内单号', right_on='内单号', how='inner')
    zhuangche_qifei.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\03_出库-起飞.csv'.format(i), encoding="utf_8_sig", index=False)
