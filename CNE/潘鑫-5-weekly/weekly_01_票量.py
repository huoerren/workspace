...
dateStr = """ BETWEEN '2022-01-23 16:00:00' and '2022-01-30 16:00:00'   """
channelCode = """ 'CNE全球特惠' """
desList = [ 'AT','PT']
...
def getAcount(i):
    ...
    d_d2_d1 = pd.merge(d4, d1[["内单号", "装车时间"]], left_on="内单号", right_on="内单号", how='inner')
    d_d2_d1.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\特殊节点_首扫-装车.csv'.format(i), encoding="utf_8_sig", index=False)
    ...
    zhuangche_ckqingguan.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\03_装车-出口清关.csv'.format(i), encoding="utf_8_sig", index=False)
    ...
    d_01_02_03_d5 = pd.merge(d_01_02_03, d5[["内单号", "起飞时间"]], left_on="内单号", right_on="内单号", how='inner')
    d_01_02_03_d5.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\04_出口清关-起飞.csv'.format(i), encoding="utf_8_sig", index=False)

    # 特别指出：装车 到 起飞 段 如下：

    zhuangche_qifei = pd.merge(d1, d5[['内单号', '起飞时间']], left_on='内单号', right_on='内单号', how='inner')
    zhuangche_qifei.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\03_02_装车-起飞.csv'.format(i), encoding="utf_8_sig", index=False)
