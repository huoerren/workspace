...
def getAllShiXiao():
    ...
    print('--------------  合并最后的结果 ：  -----------')
    frames = [df_shousao_tuotou_02, df_shousao_fengdai, df_fengdai_zhuangche, df_zhuangche_qifei, df_qifei_luodi,
              df_luodi_qingguan, df_qingguan_jiaofu, df_jiaofu_tuotou]
