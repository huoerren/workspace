...
def getAllShiXiao():
    ...
    print('--------------  合并最后的结果 ：  -----------')
    frames = [df_shousao_fengdai, df_fengdai_zhuangche, df_zhuangche_qifei_2, df_qifei_luodi_2, df_luodi_qingguan_2,
              df_qingguan_jiaofu_2, df_jiaofu_tuotou_2, df_shousao_tuotou_2]
