...
def getAcount(i):
    ...
    zhuangche_qifei.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\03_装车-起飞.csv'.format(i), encoding="utf_8_sig",
                           index=False)
   ...
   and ( (lgo.platform='WISH_ONLINE') and (lgo.customer_id in (1151368,1151370,1181372,1181374)) ) 
    ...
    d_d5_d61_d62_d63.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\05_起飞-落地.csv'.format(i), encoding="utf_8_sig",
                            index=False)
    ...
    and lgo.des = '{}' 
        ...
        and tme.is_deleted='n'
        and event_code in ("IRCM","PVCS","IRCN","RFIC","BGRK","RHCC","RHIR","RFES","RELE")
    """.format(dateStr, channelCode, i)
    d71 = execude_sql(S71)
   ...
   and ( (lgo.platform='WISH_ONLINE') and (lgo.customer_id in (1151368,1151370,1181372,1181374)) ) 
    ...
    d_61_62_63_d_71_72_73 = pd.merge(d_61_62_63, d_71_72_73[["内单号", "进口清关时间"]], left_on="内单号", right_on="内单号",
                                     how='inner')
    d_61_62_63_d_71_72_73.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\06_落地-进口清关.csv'.format(i), encoding="utf_8_sig",
                                 index=False)
   ...
   and ( (lgo.platform='WISH_ONLINE') and (lgo.customer_id in (1151368,1151370,1181372,1181374)) ) 
    ...
    d_d71_d72_d73_d3.to_csv(r'C:\Users\hp\Desktop\cujia-11data\{}\07_进口清关-交付.csv'.format(i), encoding="utf_8_sig",
                            index=False)
