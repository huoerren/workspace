...
def findFood(city, data):
    ...
    for data in json.loads(data)["shopBeans"]:
        ...
        # params = (shopUrl, shopName, shopId, shopPower, mainRegionName, mainCategoryName, tasteScore, environmentScore,
        #           serviceScore, avgPrice, shopAddress, defaultPic, city)

        params = ( shopName , shopUrl , city)
        try:
